/**
  ...
  ******************************************************************************
  */
#ifndef AI_PLANTS_VILLAGE_PT_H
#define AI_PLANTS_VILLAGE_PT_H

#include "plants_village_pt_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_PLANTS_VILLAGE_PT_MODEL_NAME          "plants_village_pt"
#define AI_PLANTS_VILLAGE_PT_ORIGIN_MODEL_NAME   "plants_model_small_16_16_adam"

/******************************************************************************/
#define AI_PLANTS_VILLAGE_PT_ACTIVATIONS_ALIGNMENT   (4)
#define AI_PLANTS_VILLAGE_PT_INPUTS_IN_ACTIVATIONS   (4)
#define AI_PLANTS_VILLAGE_PT_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_PLANTS_VILLAGE_PT_IN_NUM        (1)

AI_DEPRECATED
#define AI_PLANTS_VILLAGE_PT_IN \
  ai_plants_village_pt_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_PLANTS_VILLAGE_PT_IN_SIZE { \
  AI_PLANTS_VILLAGE_PT_IN_1_SIZE, \
}
#define AI_PLANTS_VILLAGE_PT_IN_SIZE_BYTES { \
  AI_PLANTS_VILLAGE_PT_IN_1_SIZE_BYTES, \
}
#define AI_PLANTS_VILLAGE_PT_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_PLANTS_VILLAGE_PT_IN_1_HEIGHT      (3)
#define AI_PLANTS_VILLAGE_PT_IN_1_WIDTH       (16)
#define AI_PLANTS_VILLAGE_PT_IN_1_CHANNEL     (16)
#define AI_PLANTS_VILLAGE_PT_IN_1_SIZE        (768)
#define AI_PLANTS_VILLAGE_PT_IN_1_SIZE_BYTES  (768)

/******************************************************************************/
#define AI_PLANTS_VILLAGE_PT_OUT_NUM       (1)

AI_DEPRECATED
#define AI_PLANTS_VILLAGE_PT_OUT \
  ai_plants_village_pt_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_PLANTS_VILLAGE_PT_OUT_SIZE { \
  AI_PLANTS_VILLAGE_PT_OUT_1_SIZE, \
}
#define AI_PLANTS_VILLAGE_PT_OUT_SIZE_BYTES { \
  AI_PLANTS_VILLAGE_PT_OUT_1_SIZE_BYTES, \
}
#define AI_PLANTS_VILLAGE_PT_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_PLANTS_VILLAGE_PT_OUT_1_CHANNEL     (15)
#define AI_PLANTS_VILLAGE_PT_OUT_1_SIZE        (15)
#define AI_PLANTS_VILLAGE_PT_OUT_1_SIZE_BYTES  (15)

/******************************************************************************/
#define AI_PLANTS_VILLAGE_PT_N_NODES (14)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup plants_village_pt
 ...
 * @ref ai_plants_village_pt_create. Both the activations memory buffer 
 ...
 * using @ref ai_plants_village_pt_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_plants_village_pt_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_plants_village_pt_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_PLANTS_VILLAGE_PT_*
 * defines into file @ref plants_village_pt.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_plants_village_pt_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_PLANTS_VILLAGE_PT_H */
