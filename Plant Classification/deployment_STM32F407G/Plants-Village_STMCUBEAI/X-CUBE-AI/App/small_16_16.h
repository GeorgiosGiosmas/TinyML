/**
  ...
  ******************************************************************************
  */
#ifndef AI_SMALL_16_16_H
#define AI_SMALL_16_16_H

#include "small_16_16_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_SMALL_16_16_MODEL_NAME          "small_16_16"
#define AI_SMALL_16_16_ORIGIN_MODEL_NAME   "plants_model_small_16_16_adam"

/******************************************************************************/
#define AI_SMALL_16_16_ACTIVATIONS_ALIGNMENT   (4)
#define AI_SMALL_16_16_INPUTS_IN_ACTIVATIONS   (4)
#define AI_SMALL_16_16_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_SMALL_16_16_IN_NUM        (1)

AI_DEPRECATED
#define AI_SMALL_16_16_IN \
  ai_small_16_16_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_SMALL_16_16_IN_SIZE { \
  AI_SMALL_16_16_IN_1_SIZE, \
}
#define AI_SMALL_16_16_IN_SIZE_BYTES { \
  AI_SMALL_16_16_IN_1_SIZE_BYTES, \
}
#define AI_SMALL_16_16_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_SMALL_16_16_IN_1_HEIGHT      (3)
#define AI_SMALL_16_16_IN_1_WIDTH       (16)
#define AI_SMALL_16_16_IN_1_CHANNEL     (16)
#define AI_SMALL_16_16_IN_1_SIZE        (768)
#define AI_SMALL_16_16_IN_1_SIZE_BYTES  (768)

/******************************************************************************/
#define AI_SMALL_16_16_OUT_NUM       (1)

AI_DEPRECATED
#define AI_SMALL_16_16_OUT \
  ai_small_16_16_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_SMALL_16_16_OUT_SIZE { \
  AI_SMALL_16_16_OUT_1_SIZE, \
}
#define AI_SMALL_16_16_OUT_SIZE_BYTES { \
  AI_SMALL_16_16_OUT_1_SIZE_BYTES, \
}
#define AI_SMALL_16_16_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_SMALL_16_16_OUT_1_CHANNEL     (15)
#define AI_SMALL_16_16_OUT_1_SIZE        (15)
#define AI_SMALL_16_16_OUT_1_SIZE_BYTES  (15)

/******************************************************************************/
#define AI_SMALL_16_16_N_NODES (14)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup small_16_16
 ...
 * @ref ai_small_16_16_create. Both the activations memory buffer 
 ...
 * using @ref ai_small_16_16_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_small_16_16_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_small_16_16_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_SMALL_16_16_*
 * defines into file @ref small_16_16.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_small_16_16_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_SMALL_16_16_H */
